  ...
  <div class="container">
    ...
    <div class="owl-carousel owl-all">
      <div class="block-team-member-1 text-center rounded h-100">
        <figure>
          <img src="{{ url('assets/client/images/person_1.jpg') }}" alt="Image" class="img-fluid rounded-circle">
        </figure>
      ...
      <div class="block-team-member-1 text-center rounded h-100">
        <figure>
          <img src="{{ url('assets/client/images/person_2.jpg') }}" alt="Image" class="img-fluid rounded-circle">
        </figure>
      ...
      <div class="block-team-member-1 text-center rounded h-100">
        <figure>
          <img src="{{ url('assets/client/images/person_3.jpg') }}" alt="Image" class="img-fluid rounded-circle">
        </figure>
...
<div class="block__73694 site-section border-top" id="why-us-section">
  <div class="container">
    <div class="row d-flex no-gutters align-items-stretch">
      ...
      <div class="col-12 col-lg-6 block__73422 order-lg-2" style="background-image: url('{{ url('assets/client/images/cargo_sea_small.jpg') }}');" data-aos="fade-left" data-aos-delay="">
      </div>
